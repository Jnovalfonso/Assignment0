...

{
    ...
    public Refrigerator(int itemNumber, string brand, int quantity, double wattage, string color, decimal price, short doors, int width, int height) : base(itemNumber, brand, quantity, wattage, color, price)
