namespace ModernAppliances.Appliances
{
    ...
    internal class Dishwasher : Appliance
    {
        ...
        public Dishwasher(long itemNumber, string brand, int quantity, double wattage, string color, decimal price, string feature, string soundRating) : base(itemNumber, brand, quantity, wattage, color, price)
        {
